      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-gray-100 text-[#757575] text-[10px] uppercase tracking-widest font-black bg-gray-50/50">
                <th className="px-8 py-5">Plant Identity</th>
                <th className="px-8 py-5">Robot / Track</th>
